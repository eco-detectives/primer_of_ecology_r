...
* both populations may have a negative marginal growth rate with respect to themselves (in which case any perturbation away from $N_i$ will push that population back toward the equilibrium)
* OR any populations where marginal growth rate is positive must be counterbalanced by a population where the marginal growth rate is even more negative.
