...
output: 
  ...
  pdf_document:
    toc: false
---
# Question for Casey: Can you review what you did here in the initial R chunk (apart from loading packages)? -Sean

# Question: Why do we need to Commit before we Push? Do we ever Push without Committing? -Sean
...
So the intrinsic rate of growth is `r format(round(rate, 2), nsmall = 2)` new human per human per year. 
