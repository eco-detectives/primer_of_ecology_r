...
hist(unatt.sim, xlab = "Simulated # of Unattacked Hosts", prob = TRUE, xlim = c(1000, 1070))
abline(v = 1066, lty = 3)
...
`k=10` = dnbinom(0:5, mu = 0.5, size = 10), `k=1` = dnbinom(0:5,
mu = 0.5, size = 1), `k=0.01` = dnbinom(0:5, mu = 0.5,
size = 0.01))
matplot(0:5, nb.dat, type = "b", pch = 1:4, col = 1, ylim = c(0, 1), xlab = "Attacks per Hosts", ylab = "Probability")
