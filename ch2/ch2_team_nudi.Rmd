...
If I base myself off of the elasticity estimate, then it should be the last adult stage. 
...
data2 <-  project_pop(project = project_vect, pop = c(0, rep(100,times=6)),year=100)[[2]]
