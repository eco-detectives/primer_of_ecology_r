...
proj_df <- as.data.frame(proj_mat) %>% 
  setNames(stage_names) %>%
  `rownames<-` (stage_names) ### is there a cleaner way to set all row names in dplyr pipe?

rownames(proj_df) <- stage_names
...
pop_projection <- proj_pop2(p_mat, n_0t, yrs = 20)
